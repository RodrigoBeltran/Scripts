...
// FUNCION SCROLL LATERAL INVENTARIO INFERIOR
// $('.oth-inv-container').on('mousewheel DOMMouseScroll', function(event) {
...
$(document).on("mouseenter", ".item-slot, .item-money", function(e) {
    e.preventDefault();
    over_button.play();
    if ($(this).data("item") != null) {
        animOut = true;
        clearTimeout(timeOut);
        $(".ply-iteminfo-container").removeClass("anim-salida-info").fadeIn(150);
        FormatItemInfo($(this).data("item"));
    } else {
        // if (!$(".ply-iteminfo-container").hasClass("anim-salida-info")) {
        //     setTimeout(function() {
        //         $(".ply-iteminfo-container").addClass("anim-salida-info").fadeOut(300);
        //     }, 1000);
        // }

    }
    if ($(this).parent().hasClass("player-inventory") && $(".oth-inv-container").css("display") == "block" && $(this).data("item") != null) {
        //$(".ply-iteminfo-container").css("top", "194px");
        $(".ply-iteminfo-container").removeClass("inv-normal").addClass("inv-up");

    } else if ($(this).parent().hasClass("other-inventory") && $(".oth-inv-container").css("display") == "block") {
        $(".ply-iteminfo-container").removeClass("inv-up");
...
$(document).on("mouseleave", ".item-slot, .item-money", function(e) {
    ...
    timeOut = setTimeout(function() {
        ...
        animOut = false;
        if (!animOut) {
            $(".ply-iteminfo-container").addClass("anim-salida-info").fadeOut(300, function() {
                $(this).removeClass("anim-salida-info");
...
$(document).on('mousedown', '.item-slot', function(event) {
    switch (event.which) {
        case 3:
            ...
            if ($(fromInventory[0]).hasClass("player-inventory") == false || $('.oth-inv-container').css("display") == "none") {
        ...
        if (ItemData.name !== undefined) {
            if ((ItemData.name).split("_")[0] == "weapon") {
                if (!$("#weapon-attachments").length) {
                    ...
                    $(".inv-options-list").append('<div class="inv-option-item" id="weapon-attachments"><p><i class="fas fa-search"></i> Información</p></div>');
    ...
    $.post("https://qb-inventory/GetWeaponData", JSON.stringify({
        ...
        if (data.AttachmentData !== null && data.AttachmentData !== undefined) {
            if (data.AttachmentData.length > 0) {
                ...
                $(".weapon-attachments-title").html('<span style="font-weight: bold; letter-spacing: .1vh;">Este arma no tiene componentes añadidos.</span>');
            }
        } else {
            $(".weapon-attachments-title").html('<span style="font-weight: bold; letter-spacing: .1vh;">Este arma no tiene componentes añadidos.</span>');
        }
...
function FormatItemInfo(itemData) {
    if (itemData != null && itemData.info != "") {
        if (itemData.name == "id_card") {
            ...
            $(".item-info-description").html('<p><strong>CSN: </strong><span>' + itemData.info.citizenid + '</span></p><p><strong>Primer Nombre: </strong><span>' + itemData.info.firstname + '</span></p><p><strong>Segundo Nombre: </strong><span>' + itemData.info.lastname + '</span></p><p><strong>Fecha de Nacimiento: </strong><span>' + itemData.info.birthdate + '</span></p><p><strong>Género: </strong><span>' + gender + '</span></p><p><strong>Nacionalidad: </strong><span>' + itemData.info.nationality + '</span></p>');
        } else if (itemData.name == "driver_license") {
            $(".item-info-title").html('<p>' + itemData.label + '</p>')
            $(".item-info-description").html('<p><strong>Primer nombre: </strong><span>' + itemData.info.firstname + '</span></p><p><strong>Segundo Nombre: </strong><span>' + itemData.info.lastname + '</span></p><p><strong>Fecha de Nacimiento: </strong><span>' + itemData.info.birthdate + '</span></p><p><strong>Licencias: </strong><span>' + itemData.info.type + '</span></p>');
        } else if (itemData.name == "lawyerpass") {
            $(".item-info-title").html('<p>' + itemData.label + '</p>')
            $(".item-info-description").html('<p><strong>Pass-ID: </strong><span>' + itemData.info.id + '</span></p><p><strong>Primer Nombre: </strong><span>' + itemData.info.firstname + '</span></p><p><strong>Segundo Nombre: </strong><span>' + itemData.info.lastname + '</span></p><p><strong>CSN: </strong><span>' + itemData.info.citizenid + '</span></p>');
            ...
            if (itemData.info.type == "casing") {
                $(".item-info-description").html('<p><strong>Material de Evidencias: </strong><span>' + itemData.info.label + '</span></p><p><strong>Tipo de Numero: </strong><span>' + itemData.info.ammotype + '</span></p><p><strong>Calibre: </strong><span>' + itemData.info.ammolabel + '</span></p><p><strong>Numero de Serie: </strong><span>' + itemData.info.serie + '</span></p><p><strong>Escena del Crimen: </strong><span>' + itemData.info.street + '</span></p><br /><p>' + itemData.description + '</p>');
            } else if (itemData.info.type == "blood") {
                $(".item-info-description").html('<p><strong>Material de Evidencias: </strong><span>' + itemData.info.label + '</span></p><p><strong>Tipo de Sangre: </strong><span>' + itemData.info.bloodtype + '</span></p><p><strong>Codigo DNA: </strong><span>' + itemData.info.dnalabel + '</span></p><p><strong>Escena del Crimen: </strong><span>' + itemData.info.street + '</span></p><br /><p>' + itemData.description + '</p>');
            } else if (itemData.info.type == "fingerprint") {
                $(".item-info-description").html('<p><strong>Material de Evidencias: </strong><span>' + itemData.info.label + '</span></p><p><strong>Vingerpatroon: </strong><span>' + itemData.info.fingerprint + '</span></p><p><strong>Plaats delict: </strong><span>' + itemData.info.street + '</span></p><br /><p>' + itemData.description + '</p>');
            } else if (itemData.info.type == "dna") {
                $(".item-info-description").html('<p><strong>Material de Evidencias: </strong><span>' + itemData.info.label + '</span></p><p><strong>Codigo DNA: </strong><span>' + itemData.info.dnalabel + '</span></p><br /><p>' + itemData.description + '</p>');
            }
            ...
            $(".item-info-title").html('<p>' + itemData.label + '</p>')
            $(".item-info-description").html('<p>Dinero marcado</p>');
...
function handleDragDrop() {
    ...
    $(".item-drag").draggable({
        ...
        stop: function(event, ui) {
            ...
            /*             if (inUse['use'] != true && inUse['give'] != true) {
...
function updateweights($fromSlot, $toSlot, $fromInv, $toInv, $toAmount) {
    ...
    if ($fromInv.attr("data-inventory").split("-")[0] != "itemshop" && $toInv.attr("data-inventory").split("-")[0] != "itemshop" && $fromInv.attr("data-inventory") != "crafting" && $toInv.attr("data-inventory") != "crafting") {
        ...
        $("#other-inv-weight").html("Espacio: " + (parseInt(totalWeightOther) / 1000).toFixed(2) + " / " + (otherMaxWeight / 1000).toFixed(2))
    }
...
(() => {
    ...
    Inventory.Open = function(data) {
        ...
        $("#player-inv-weight").html("Espacio: " + (totalWeight / 1000).toFixed(2) + " / " + (data.maxweight / 1000).toFixed(2));
        ...
        if (data.other != null) {
            ...
            if (name != null && (name.split("-")[0] == "itemshop" || name == "crafting")) {
                ...
                $("#other-inv-label").html(data.other.label)
                $("#other-inv-weight").html("Espacio: " + (totalWeightOther / 1000).toFixed(2) + " / " + (data.other.maxweight / 1000).toFixed(2))
            }
            otherMaxWeight = data.other.maxweight;
            otherLabel = data.other.label;
        } else {
            $("#other-inv-label").html(Inventory.droplabel)
            $("#other-inv-weight").html("Espacio: " + (totalWeightOther / 1000).toFixed(2) + " / " + (Inventory.dropmaxweight / 1000).toFixed(2))
