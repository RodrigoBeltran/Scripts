...
Config.Locations = {
    ...
    ["duty"] = {
        [1] = vector4(300.9, -596.26, 43.28, 0.0),
    },    
    ["vehicle"] = {
    ...
    ["hall"] = {
        [1] = vector4(330.25, -600.97, 43.28, 245.5),
    },
    
    ["parking"] = {
        [1] = vector4(342.4, -585.41, 28.8, 245.5),
    },
    ["cloackroom"] = {
        [1] = vector4(298.98, -598.27, 43.28, 247.3),
    },
    ["buyClothes"] = {
        [1] = vector4(301.52, -599.62, 43.28, 68.19),
    },
    ["main"] = {
    ...
    ["beds"] = {
        ...
        [6] = {coords = vector4(364.93, -585.86, 43.28, 67.5), taken = false, model = 1631638868}, 
    }
}
...
Config.Helicopter = "lsfdmav"

Config.Items = {
    label = "Armario médico",
    slots = 30,
    items = {
        [1] = {
            name = "radio",
...
Config.BillCost = 300
Config.DeathTime = 20 -- ORIGINAL 300
Config.CheckTime = 10
...
Config.MaxInjuryChanceMulti = 1
Config.ForceInjury = 10
...
Config.BleedingStates = {
    [1] = {label = 'sangrando un poco..', damage = 10, chance = 50},
    [2] = {label = 'sangrando..', damage = 15, chance = 65},
    [3] = {label = 'sangrando bastante..', damage = 20, chance = 65},
    [4] = {label = 'sangrando muchísimo..', damage = 25, chance = 75},
}
