        ...
        Citizen.CreateThread(function()
            while InLaststand do
                ...
                elseif LaststandTime - 1 <= 0 then
                    QBCore.Functions.Notify("Te has desangrado ...", "error")
                    SetLaststand(false)
...
AddEventHandler('hospital:client:UseFirstAid', function()
    if not isEscorting then
        ...
        QBCore.Functions.Notify('Acción imposible!', 'error')
    end
end)
...
AddEventHandler('hospital:client:HelpPerson', function(targetId)
    ...
    QBCore.Functions.Progressbar("hospital_revive", "Reviviendo persona...", math.random(30000, 60000), false, true, {
        ...
        ClearPedTasks(ped)
        QBCore.Functions.Notify("Reviviste a una persona.")
