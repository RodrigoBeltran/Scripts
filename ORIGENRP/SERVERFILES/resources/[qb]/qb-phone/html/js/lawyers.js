SetupLawyers = function(data) {
    ...
    if (data.length > 0) {
        ...
        $(".lawyers-list").append('<br><h1 style="font-size:1.641025641025641vh; padding:1.0256410256410255vh; color:#fff; margin-top:0; width:100%; display:block; background-color: rgb(0, 0, 0);">Mecánicos (' + mechanic.length + ')</h1>');
        ...
        $(".lawyers-list").append('<br><h1 style="font-size:1.641025641025641vh; padding:1.0256410256410255vh; color:#fff; margin-top:0; width:100%; display:block; background-color: rgb(0, 0, 0);">Policías (' + police.length + ')</h1>');
        ...
        $(".lawyers-list").append('<br><h1 style="font-size:1.641025641025641vh; padding:1.0256410256410255vh; color:#fff; margin-top:0; width:100%; display:block; background-color: rgb(0, 0, 0);">Médicos (' + ambulance.length + ')</h1>');
        ...
        if (ambulance.length > 0) {
            ...
            var element = '<div class="lawyer-list"><div class="no-lawyers">No hay personal médico disponible.</div></div>'
            $(".lawyers-list").append(element);
        }
                ...
                if (status.CanCall) {
                    if (!status.InCall) {
                        if (QB.Phone.Data.AnonymousCall) {
                            QB.Phone.Notifications.Add("fas fa-phone", "Teléfono", "¡Has comenzado una llamada anónima!");
                        }
                        ...
                        QB.Phone.Notifications.Add("fas fa-phone", "Teléfono", "¡Estás actualmente en una llamada!");
                    }
                } else {
                    QB.Phone.Notifications.Add("fas fa-phone", "Teléfono", "Esta persona está en una llamada ya.");
                }
            } else {
                QB.Phone.Notifications.Add("fas fa-phone", "Teléfono", "¡Esta persona no está disponible!");
            }
        } else {
            QB.Phone.Notifications.Add("fas fa-phone", "Teléfono", "¡No puedes llamarte a tu propio teléfono!");
        }
    });
});
