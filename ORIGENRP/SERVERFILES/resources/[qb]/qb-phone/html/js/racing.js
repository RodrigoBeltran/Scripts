    ...
    $.post('https://qb-phone/IsAuthorizedToCreateRaces', JSON.stringify({}), function(data){
        if (data.IsAuthorized) {
            if (!data.IsBusy) {
                ...
                QB.Phone.Notifications.Add("fas fa-flag-checkered", "Racing", "Ya estás creando una carrera", "#1DA1F2");
            }
        } else {
            QB.Phone.Notifications.Add("fas fa-flag-checkered", "Racing", "No puedes crear carreras.", "#1DA1F2");
        }
    });
});
...
$(document).on('click', '#racing-create-accept', function(e){
    ...
    if (TrackName !== "" && TrackName !== undefined && TrackName !== null) {
        ...
        $.post('https://qb-phone/IsAuthorizedToCreateRaces', JSON.stringify({
            ...
            if (data.IsAuthorized) {
                if (data.IsNameAvailable) {
                    ...
                    QB.Phone.Notifications.Add("fas fa-flag-checkered", "Racing", "El nombre no está disponible.", "#1DA1F2");
                }
            } else {
                QB.Phone.Notifications.Add("fas fa-flag-checkered", "Racing", "No puedes crear carreras.", "#1DA1F2");
            }
        ...
        QB.Phone.Notifications.Add("fas fa-flag-checkered", "Racing", "Tienes que introducir un nombre de carrera...", "#1DA1F2");
    }
});
