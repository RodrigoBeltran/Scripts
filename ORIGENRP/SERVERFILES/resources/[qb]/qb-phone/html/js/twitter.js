...
$("#tweet-new-url").off("keyup").on("keyup", function(){
...
$(document).on('click', '#voice-tweet-button', function(e) {
    e.preventDefault();
    console.log("tweet button");

    if (!usingVoiceDictation) {
        $('#voice-tweet-button').html("Escuchando")
    ...
    if (hashtags !== null) {
        ...
        $.each(hashtags, function(i, hashtag) {
            ...
            if (hashtag.messages.length >= MinimumTrending) {
                Elem = '<div class="twitter-hashtag" id="tag-' + hashtag.hashtag + '"><div class="twitter-hashtag-status">En tendencia</div> <div class="twitter-hashtag-tag">#' + hashtag.hashtag + '</div> <div class="twitter-hashtag-messages">' + hashtag.messages.length + ' ' + TweetHandle + '</div> </div>';
            } else {
                Elem = '<div class="twitter-hashtag" id="tag-' + hashtag.hashtag + '"><div class="twitter-hashtag-status"></div> <div class="twitter-hashtag-tag">#' + hashtag.hashtag + '</div> <div class="twitter-hashtag-messages">' + hashtag.messages.length + ' ' + TweetHandle + '</div> </div>';
            }
