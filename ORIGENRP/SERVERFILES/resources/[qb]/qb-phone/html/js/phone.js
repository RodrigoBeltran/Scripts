...
var sound_4 = document.getElementById("sound_4");
var sound_5 = document.getElementById("sound_5");
var sound_6 = document.getElementById("sound_6");
var sound_7 = document.getElementById("sound_7");
var sound_8 = document.getElementById("sound_8");
var sound_9 = document.getElementById("sound_9");
var sound_0 = document.getElementById("sound_0");
var sound_corchete = document.getElementById("sound_corchete");
var sound_asterisco = document.getElementById("sound_asterisco");
...
sound_9.volume = 0.1;
sound_0.volume = 0.1;
sound_corchete.volume = 0.1;
sound_asterisco.volume = 0.1;
...
$(document).on('click', function(e) {
    ...
    if (usingTextArea) {
        if (!(document.activeElement.nodeName == 'TEXTAREA' || document.activeElement.nodeName == 'INPUT')) {
            usingTextArea = false;
            $.post('https://qb-phone/UsingTextArea', JSON.stringify({
                using: false
            }));
        }
    } else {
...
$(document).on('click', '.phone-app-footer-button', function(e) {
    ...
    if (PressedFooterTab !== CurrentFooterTab) {
        ...
        $(".phone-" + CurrentFooterTab).fadeOut();
        $(".phone-" + PressedFooterTab).fadeIn(150);
                ...
                if (status.CanCall) {
                    if (!status.InCall) {
                        if (QB.Phone.Data.AnonymousCall) {
                            QB.Phone.Notifications.Add("fas fa-phone", "Phone", "Estás llamando de forma anónima!");
                        }
                    ...
                    QB.Phone.Notifications.Add("fas fa-phone", "Phone", "Persona ocupada!");
                }
            } else {
                QB.Phone.Notifications.Add("fas fa-phone", "Phone", "No disponible!");
            }
        } else {
            QB.Phone.Notifications.Add("fas fa-phone", "Phone", "No te puedes llamar a ti mismo!");
        }
    });
});
        ...
        if (cData.number !== QB.Phone.Data.PlayerData.charinfo.phone) {
            if (status.IsOnline) {
                if (status.CanCall) {
                    ...
                    QB.Phone.Notifications.Add("fas fa-phone", "Phone", "El número está ocupado o fuera de cobertura.");
                }
            } else {
...
QB.Phone.Functions.LoadContacts = function(myContacts) {
    ...
    if (myContacts !== null) {
        ...
        $("#total-contacts").text("Sin contactos");
    }
...
$(document).on('click', '#new-chat-phone', function(e) {
    ...
    if (ContactData.number !== QB.Phone.Data.PlayerData.charinfo.phone) {
        ...
        QB.Phone.Notifications.Add("fa fa-phone-alt", "Phone", "No puedes escribirte a tí mismo...", "default", 3500);
    }
});
...
$(document).on('click', '#edit-contact', function(e) {
    ...
    $(".phone-edit-contact-header").text("Editando: " + ContactData.name)
...
$(document).on('click', '.phone-keypad-key', function(e) {
    ...
    if (!isNaN(PressedButton)) {
        ...
        if (ClearNumberTimer == null) {
            $("#phone-keypad-input").text("Número erróneo")
            ...
            if (status.IsOnline) {
                if (status.CanCall) {
                    if (!status.InCall) {
                        ...
                        QB.Phone.Notifications.Add("fas fa-phone", "Teléfono", "¡Ya estás en una llamada!");
                    }
                } else {
                    QB.Phone.Notifications.Add("fas fa-phone", "Teléfono", "¡Este persona está en una llamada!");
                }
            } else {
                QB.Phone.Notifications.Add("fas fa-phone", "Teléfono", "¡Esta persona no esta disponible!");
            }
        } else {
            QB.Phone.Notifications.Add("fas fa-phone", "Teléfono", "¡No puedes llamar a tu propio número!");
        }
    });
}
    ...
    if (!Canceled) {
        if (!QB.Phone.Data.CallActive) {
            ...
            setTimeout(function() {
                ...
                if (AnonymousCall) {
                    Label = "Te está llamando una persona anónima"
                }
...
QB.Phone.Functions.SetupCurrentCall = function(cData) {
    if (cData.InCall) {
        ...
        console.log(JSON.stringify(cData.TargetData));
        ...
        $(".phone-application-container>div").each(function() {
            ...
            if ($(this).hasClass("phone-call-app") == false || $(this).hasClass("phone-footer") == false) {
...
QB.Phone.Functions.SetupSuggestedContacts = function(Suggested) {
    ...
    if (AmountOfSuggestions > 0) {
        ...
        $(".amount-of-suggested-contacts").html('<i class="fas fa-exclamation-triangle"></i> No hay contactos sugeridos');
    }
}
