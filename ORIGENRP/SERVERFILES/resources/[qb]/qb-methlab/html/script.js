...
Laptop.Open = function(data) {
    ...
    $.each(data.tasks, function(i, task){
        ...
        var elem = '<div class="methlab-task" data-task="' + (i + 1) + '"> <div class="methlab-task-label">Horno ' + (i + 1) + ': ' + task.label + '</div> <div class="methlab-task-completed">Voltooid: ' + Completed + '</i></div> </div>';
