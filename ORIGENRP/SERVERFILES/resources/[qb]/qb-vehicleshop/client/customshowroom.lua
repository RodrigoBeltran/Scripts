            ...
            if dist < 15 then
                ...
                if dist < 2 then
                    if veh == testritveh then
                        DrawText3Ds(bringcoords.x, bringcoords.y, bringcoords.z, 'E - Devolver Vehiculo')
            ...
            if dist < 2 then
                if PlayerJob ~= nil then
                    if PlayerJob.name == 'cardealer' then
                        DrawText3Ds(QBCustom.ShowroomPositions[ClosestCustomVehicle].coords.x, QBCustom.ShowroomPositions[ClosestCustomVehicle].coords.y, QBCustom.ShowroomPositions[ClosestCustomVehicle].coords.z + 1.9, 'G - Cambiar Vehiculo')
                        DrawText3Ds(QBCustom.ShowroomPositions[ClosestCustomVehicle].coords.x, QBCustom.ShowroomPositions[ClosestCustomVehicle].coords.y, QBCustom.ShowroomPositions[ClosestCustomVehicle].coords.z + 1.75, '/sell [id] - Vender Vehiculo /testdrive - Probar Vehiculo')
                        ...
                        if QBCustom.ShowroomPositions[ClosestCustomVehicle].buying then
                            DrawText3Ds(QBCustom.ShowroomPositions[ClosestCustomVehicle].coords.x, QBCustom.ShowroomPositions[ClosestCustomVehicle].coords.y, QBCustom.ShowroomPositions[ClosestCustomVehicle].coords.z + 1.6, '7 - Confirmar / 8 - Cancelar - ($'..QBCore.Shared.Vehicles[QBCustom.ShowroomPositions[ClosestCustomVehicle].vehicle].price..',-)')
...
AddEventHandler('qb-vehicleshop:client:SellCustomVehicle', function(TargetId)
    ...
    if player ~= -1 and distance < 2.5 then
        ...
        if VehicleDist < 2.5 then
            ...
            QBCore.Functions.Notify('Nadie cerca del vehículo', 'error')
        end
    else
