Config = {
    ...
    -- NOte this might cause an issue of the image getting stuck on peoples screens
        ...
        MenuImage = "https://cdn.discordapp.com/attachments/844929849377947738/895971448458477608/F3.png",
    -- You can change the menu position here
        MenuPosition = "bottom-right", -- (left, right)
    ...
    Config.Languages = {
      ...
      ['es'] = {
            ...
            ['walkingstyles'] = "🚶‍♀️🚶🏿‍♂️ Formas de caminar",
            ...
            ['infoupdateavtext'] = "Una actualizacion esta disponible, para conseguir la ultima version ingresa a ~y~https://github.com/andristum/dpemotes",
            ['suggestions'] = "Bienvenido a BandolerosRP",
            ['suggestionsinfo'] = "",
            ...
            ['doyouwanna'] = "~y~Y para aceptar, L para rechazar (",
            ['refuseemote'] = "Animacion rechazada.",
            ['makenearby'] = "hacer que el jugador cercano juegue",
            ['camera'] = "Mantén ~y~Z~w~  para usar el flash de la camara.",
            ['makeitrain'] = "Mantén ~y~Z~w~  para hacer llover.",
            ['pee'] = "Mantén ~y~Z~w~  para mear.",
            ['spraychamp'] = "Mantén ~y~Z~w~ rociar champán.",
            ['bound'] = "Unida ",
            ['to'] = "a",
