...
function EmoteChatMessage(args)
  if args == display then
    ...
    TriggerEvent("chatMessage", "^aAnimaciones | ".. string.format(""))

  else
    TriggerEvent("chatMessage", "^aAnimaciones | ".. string.format(""..args..""))
  end
end
...
function EmotesOnCommand(source, args, raw)
  ...
  for a in pairsByKeys(DP.Sex) do
    EmotesCommand = EmotesCommand .. ""..a..", "
  end
...
function EmoteMenuStart(args, hard)
    ...
    elseif etype == "expression" then
      ...
      elseif etype == "Sex" then
        if DP.Sex[name] ~= nil then
          if OnEmotePlay(DP.Sex[name]) then end
        end
    end
end
...
function EmoteCommandStart(source, args, raw)
    ...
    elseif DP.Sex[name] ~= nil then
      if OnEmotePlay(DP.Sex[name]) then end return
    else
