...
DP.Walks = {
  ...
  ["Hombre-redeterminado"] = {"move_m@multiplayer"},
  ...
  ["Llevarbasura"] = {"clipset@move@trash_fast_turn"},
  ["Llevarbasura2"] = {"missfbi4prepp1_garbageman"},
  ["Trevor"] = {"move_p_m_two"},
  ["Amplio"] = {"move_m@bag"},
...
RegisterKeyMapping('crossarms', 'Cruzar Brazos', 'keyboard', 'G')